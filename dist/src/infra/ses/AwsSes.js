...
var AwsSes = /** @class */ (function (_super) {
    __extends(AwsSes, _super);
    function AwsSes() {
        var _this = _super.call(this) || this;
        _this._log = typedi_1.Container.get(utils_1.utils.Logger);
        return _this;
    }
    /**
     ...
     * @returns Promise<any>
     */
    AwsSes.prototype.sendResetPasswordEmail = function (recipient, subject, body) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.sendEmail(recipients, subject, body)
                                .catch(function (err) {
                                _this._log.error({
